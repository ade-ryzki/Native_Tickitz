...
//                             //     "genre": "Sci-Fi",
//                             //     "release_date": "2022-06-27T17:00:00.000Z",
//                             //     "directed_by": "Jon Watss",
//                             //     "duration": "2  hours 30 minutes",
//                             //     "cast": "Tom Holland, Michael Keaton, Robert Downey Jr",
//                             //     "synopsis": "hrilled by his experience with the Avengers, Peter returns home, where he lives with his Aunt May, under the watchful eye of his new mentor Tony Stark, Peter tries to fall back into his normal daily routine - distracted by thoughts of proving himself to b",
//                             //     "image": "1657568088196-219568496-spiderman-detail.png",
//                             //     "created_at": "2022-07-11T19:34:48.000Z",
//                             //     "updated_at": "2022-07-11T19:34:48.000Z"
//                             // },{
//                             //     "id": 19,
//                             //     "title": "spiderman-home coming",
//                             //     "genre": "Sci-Fi",
...
//                 useEffect(() => {
//                     setLoading(true);
//                     axios.get('http://172.20.10.3:4000/api/v1/movies?page=1&limit=5').then((res) => {
...
//                 <ScrollView style={[commonStyle.flexRow, {margin:30, alignSelf:'center'}]} horizontal={true}>
//                     {this.state.movie.data.results.map((prop, key) => {
//                         return (
//                             <View style={[ {margin:20, alignContent:'center', backgroundColor: "#FFFFFF", borderRadius:10, padding:50}]}>
//                                 <Image source={require('../../../assets/image/spider.png')} style={[{
//                                     width: 180, height:300 , alignContent:'center', borderRadius:5, margin:10
